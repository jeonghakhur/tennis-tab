-- =============================================================================
-- Supabase public 스키마를 schema.sql 기준으로 초기화 후 재적용
-- ⚠️ 주의: public 스키마의 모든 테이블·데이터가 삭제됩니다. (auth.users 데이터는 유지)
-- 실행: Supabase Dashboard > SQL Editor 에서 이 파일 내용 붙여넣기 후 Run
-- =============================================================================

-- 1. auth.users 트리거 제거 (public 스키마 삭제 시 함께 제거되므로 선행 제거)
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;

-- 2. public 스키마 전체 삭제 후 재생성
