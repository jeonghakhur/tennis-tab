...
interface TournamentActionsProps {
    ...
    /** 대회 복사(=새 생성)는 SUPER_ADMIN만 가능 */
    canCreate?: boolean;
}

export default function TournamentActions({ tournamentId, currentStatus, hideStatusChange = false, canCreate = false }: TournamentActionsProps) {
