...
5. APPLY_TOURNAMENT: 대회 참가 신청 의사 표현 (직접 신청하겠다는 의지)
   예시: "서울 오픈 신청하고 싶어", "대회 참가 신청할래", "참가할래", "신청할게", "지원하고 싶어", "체육회장기 참석 신청해", "참석 신청할게", "참석하고 싶어"
...
- tournament_name 추출 규칙: "신청해", "참가할래", "참석하고 싶어" 등 의향 표현은 대회명에서 제외. "대회", "경기" 같은 일반 명사는 대회 정식 이름의 일부인지 문맥 판단하여 추출 (예: "체육회장기 대회 참석 신청해" → tournament_name: "체육회장기")
